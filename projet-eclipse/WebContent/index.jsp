...
<head>
<meta charset="UTF-8">
<title>Home page</title><link rel="stylesheet"
...
<body>
	...
	<div class="container-fluid bg-dark text-white text-center">
		...
		<a href="AjoutUtilisateur"> Inscription </a>
		</c:if>
		<c:if test="${ sessionScope.utilisateur != null }">
	...
	<div class="container">
		<!-- <div id="banner" class="row">
			<div class="offset-lg-2 col-lg-8">				<img src="C:\Users\MGR\git\ProjetFilRouge\projet-eclipse\WebContent\images\fleurs-de-france.png" alt="Fleurs de France">
			</div>
			end banner
		</div> -->		<div class="row">
			<div class="col">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <ol class="carousel-indicators">
      ...
      <li data-target="#myCarousel" data-slide-to="4"></li>    </ol>    <!-- Wrapper for slides -->
    <div class="carousel-inner">      <div class="item active">
        <img src="images\pommier.jpg" alt="Pommier Malus" style="width:100%;">
        <div class="carousel-caption">
          <h3>Pommier</h3>
          <p>Pommier malus, so red!</p>
        </div>
      </div>      <div class="item">
        <img src="images\Flowers.jpg" alt="flowers" style="width:100%;">
        <div class="carousel-caption">
          <h3 style="color: black;">Flowers</h3>
          <p style="color: black;">La joie des fleurs..!</p>
        </div>
      </div>      <div class="item">
        <img src="images\cerisier-napoleon.jpg" alt="Cerises" style="width:100%;">
        <div class="carousel-caption">
          <h3>Cerisier</h3>
          <p>Du bonheur dans votre jardin!</p>
        </div>
      </div>      <div class="item">
        <img src="images\citrus-faustrime.jpg" alt="citronier" style="width:100%;">
        <div class="carousel-caption">
          <h3 style="color: yellow;">Citrus faustrime</h3>
           <p style="color: yellow;">L'hybride naturel!</p>
        </div>
      </div>       <div class="item">
        <img src="images\agastache-golden-jubilee.jpg" alt="Agastache" style="width:100%;">
        <div class="carousel-caption">
